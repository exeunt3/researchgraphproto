...
const AREAS = [
  {
    ...
    existingConversation: [
      'Protection of human perception,',
      'reasoning, and decision-making from',
      'manipulation or capture. Urgency driven',
      'by algorithmic media, authoritarian',
      '"exhaustion" politics, LLM one-shotting.',
    ],
    immanenceInsert: [
      'Surveys 60s–70s counterculture for',
      'emergency cogsec tactics: black music',
      '(Coltrane, Hendrix, Marley) as havens',
      'from ontological vertigo; psychedelic',
      'epistemology of "total suspicion" as',
      'affirmative, generative immanent thought.',
    ],
    arrowLabel: 'archive as defense',
  },
  {
    ...
    color: '#2a8a7a',
    existingConversation: [
      'Michael Levin\'s basal cognition: fighting',
      '"mind-blindness" by asking what the',
      'umwelt of any organism is and what',
      'problem spaces it navigates with',
      'agency and intelligence.',
    ],
    immanenceInsert: [
      'Proposes immanent social forms — scenes,',
      'subcultures — as cognitive organisms.',
      'What is the umwelt of a scene? If such',
      'forms are cognitive yet unconscious,',
      'what is their relation to ideology and',
      'control? Where do LLMs sit on this gradient?',
    ],
    arrowLabel: 'headless cognition',
  },
  {
    ...
    color: '#3d5a8a',
    existingConversation: [
      'Avant-garde of social coordination:',
      'economic and governance design, DAOs,',
      'open protocols generalized beyond the',
      'web — distributed actors nursing and',
      'contributing to shared social and',
      'technical protocols.',
    ],
    immanenceInsert: [
      'The "protocol underground": open, headless',
      'cultures converging on open-ended empiricism',
      'that defends against rigid structure and',
      'binary thinking. Questions: cosmopolitan',
      'underground, extitutional institutions,',
      'agentic intermediaries and post-monetary',
      'Coasian singularity.',
    ],
    arrowLabel: 'protocol underground',
  },
]
